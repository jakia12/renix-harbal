...
<<<<<<< HEAD
                        ...
                        &nbsp;
                        <p className='text-justify'> Renix Laboratories (Unani) Ltd. is a healthcare company that produces high-quality complete medicines using natural herbs. With the increasing resistance to antibiotic medicines and their harmful side effects, the world is turning towards alternative medicine, and Renix Laboratories is contributing to this shift. Through extensive research on the ancient Unani treatment system, which has been modernized through scientific methods, the company has proven the success and effectiveness of this approach without any side effects. The Hon'ble Prime Minister of Bangladesh has recognized the importance of herbal medicines, and the company has appointed doctors to provide Unani health services in remote areas of the country. Renix Laboratories is committed to providing high-quality, natural healthcare solutions for people around the world.</p>
                       ...
                       {/* <div className='bg-white h-[450px] w-[400px] pt-10 pl-10 space-y-3 flex flex-col justify-content'> */}
                            ...
                            {/* <form className='space-y-3' action="">
                                <div className='mr-10'>
                                    ...
                                    <input className='outline-none h-10 px-2 border border-sm  w-full rounded-md' type="text" placeholder='Enter your name' required/>
                                </div>
                                <div className='mr-10'>
                                    <p className='font-semibold text-xl'>Email Address</p>
                                    <input className='outline-none h-10 px-2 border border-sm w-full rounded-md'  type="text" placeholder='Enter your address' required/>
=======
...
<<<<<<< HEAD
                       ...
                       <label>Name</label>
                       <input type="text" name='name' className='w-full py-2 my-2 px-2' placeholder='Your Name ...' required />
                       </fieldset>

                      {/* {/ email  /} */}
                      <fieldset className='my-2'>
                      <label>Email</label>
                      <input type="email" name='email' className='w-full py-2 my-2 px-2' placeholder='Your Email ...' required />
                      </fieldset>

                     {/* {/ subject  /} */}
                     <fieldset className='my-2'>
                     <label>Subject</label>
                     <input type="text" name='subject' className='w-full py-2 my-2 px-2' placeholder='Subject ...' required />
                     </fieldset>
                    ...
                    <div className='p-8 form-border'>
                        <form onSubmit={handleForm}>
                            ...
                            <fieldset className='my-2'>
                                ...
                                <input type="text" name='name' className='w-full py-2 my-2 px-2 input_style' placeholder='Your Name ...' required />
                            </fieldset>

                            {/* {/ email  /} */}
                            <fieldset className='my-2'>
                                <label className="contact_label">Email</label>
                                <input type="email" name='email' className='w-full py-2 my-2 px-2 input_style' placeholder='Your Email ...' required />
                            </fieldset>

                            {/* {/ subject  /} */}
                            <fieldset className='my-2'>
                                <label className="contact_label">Subject</label>
                                <input type="text" name='subject' className='w-full py-2 my-2 px-2 input_style' placeholder='Subject ...' required />
                            </fieldset>

                            {/* {/ message  /} */}
                            <fieldset className='my-2'>
                                <label className="contact_label">Message</label>
                                <textarea name="message" id="" cols="10" rows="5" className='input_style w-full py-2 my-2 px-2 h-[136px]' placeholder='Your Message ...' required></textarea>
                            </fieldset>
