...
const WebNav = () => {
    ...
    return (
        ...
        <header>
            {/* topbar nav */}
            <TopBar />
            <nav className={` w-full  top-0 right-0 left-0 z-[10] py-5 md:py-5  text-[#FFF]  flex  items-center justify-between md:mx-auto px-10 md:px-[103px]  ${stickyNav ? 'bg-white fixed shadow-md shadow-gray-200' : 'bg-white'}`}
